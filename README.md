...
tests/         pytest 587 ca / 48 file: bus, registry, golden 14 agent, preflight/analytics, media/renderer (ffmpeg nếu có),
...
- Test: 587 ca pytest (golden 14 agent, bus, registry, preflight/analytics, media/renderer + 8 provider media, timeline/QC, sandbox tiến trình, desk/gate, runner/eval, tool web + vòng tool,
